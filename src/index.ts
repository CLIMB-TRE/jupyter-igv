...
export const PLUGIN_NAMESPACE = '@jlab-igv';
...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  activate: (
    ...
    console.log('JupyterLab extension @jlab-igv is activated!');
    ...
    requestAPI<any>('version')
      .then(data => {
        ...
        console.log(`JupyterLab extension @jlab-igv version: ${version}`);
      })
      .catch(error =>
        console.error(`Failed to fetch @jlab-igv version: ${error}`)
      );
